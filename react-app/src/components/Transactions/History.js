          ...
          {transactions.map((ele) => (
            <div className="transaction">
              <div className="transaction-left-container">
                <div className="transaction-left-title">{companies?.find((company) => company.id == ele.company_id)?.name} {ele.type}</div>
                <div className="transaction-left-created">{ele.created_at}</div>
              </div>
              <div className="transaction-right-container">
                <div className="transaction-right-total">{ele.total}</div>
                <div></div>
                </div>
            </div>
          ))}
